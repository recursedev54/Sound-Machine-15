...
class SoundMachineApp:
    def __init__(self, root):
        ...
        self.root.configure(bg='#8B4513')  # Set background to brown
        ...
        self.canvas = tk.Canvas(self.root, width=800, height=600, bg='#8B4513', highlightthickness=0)
        ...
        self.controls_frame = tk.Frame(self.root, bg='#8B4513')
        self.controls_frame.pack(pady=20)
        
        self.volume_label = tk.Label(self.controls_frame, text="Volume", bg='#8B4513', fg='white')
        self.volume_label.pack()
        
        self.volume_slider = tk.Scale(self.controls_frame, from_=0, to=100, orient='horizontal', bg='#8B4513', fg='white', command=self.update_volume)
        self.volume_slider.set(50)
        self.volume_slider.pack()
        
        self.timer_label = tk.Label(self.controls_frame, text="Timer (minutes)", bg='#8B4513', fg='white')
        self.timer_label.pack()
        
        self.timer_slider = tk.Scale(self.controls_frame, from_=0, to=60, orient='horizontal', bg='#8B4513', fg='white')
